...
Reads: data/articles_with_questions_batch3.csv. Writes: data/framed_prompts_batch3.csv.
"""
import pandas as pd

df = pd.read_csv("data/articles_with_questions_batch3.csv")
...
framed_df.to_csv("data/framed_prompts_batch3.csv", index=False)
