"""Pipeline stage 4: hallucination judge — classify answers SUPPORTED/UNSUPPORTED/CONTRADICTORY using the CORRECTED judge (Llama 3.3 responses).

Reads: data/framed_prompts_batch3.csv, data/rag_responses_llama33_batch3.jsonl. Writes: data/hallucination_labels_batch3_llama33.jsonl.
"""
import os, json, time
import pandas as pd
...
OUTPUT_PATH = "data/hallucination_labels_batch3_llama33.jsonl"
