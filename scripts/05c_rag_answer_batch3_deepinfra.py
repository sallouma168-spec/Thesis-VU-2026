"""Pipeline stage 3: grounded answering — query Llama 3.1 70B (DeepInfra) on the framed prompts.

Reads: data/framed_prompts_batch3.csv. Writes: data/rag_responses_llama31_batch3.jsonl.
"""
import os, json, time
import pandas as pd
...
OUTPUT_PATH = "data/rag_responses_llama31_batch3.jsonl"
...
print(f"Target: {len(prompts)} framed prompts on {MODEL_NAME} (via DeepInfra)\n")
