...
Reads: data/framed_prompts_batch2.csv, data/rag_responses_deepseek_batch2.jsonl. Writes: data/hallucination_labels_deepseek_batch2.jsonl.
"""
import os, json, time
import pandas as pd
...
OUTPUT_PATH = "data/hallucination_labels_deepseek_batch2.jsonl"
